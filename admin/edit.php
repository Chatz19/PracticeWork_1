...
table.tables{ text-align: left; border:5px solid black; height:600px; width:850; padding: 0px; padding-top: 0px; padding-bottom: 2px;}
...
<tr><td align = "center" height = "100"><font class = "dad"><b>Product Update</b></font></td></tr>
		<tr><td>
<?php	
require_once '../config/connect.php';
$id = $_GET['id'];
...
?>
	...
	<div class ="input">
		<font class = "font">	
	Product ID:<br>
	<input type="text" name="id" placeholder="" required="required" value = "<?php echo $r['Menu_ID']; ?>"><br><br>
	Product Name:<br>
	<input type="text" name="name" placeholder="" required="required" value = "<?php echo $r['Menu_Name']; ?>"><br><br>
	Description:<br>
	<input type="text" name="description" placeholder="" required="required" value = "<?php echo $r['Description']; ?>"><br><br>
	Quantity in Stock:<br>
	<input type="text" name="quantity" placeholder="" required="required" value = "<?php echo $r['QuantityInStock']; ?>"><br><br>
	Price:<br>
	<input type="text" name="price" placeholder="" required="required" value = "#<?php echo $r['BuyPrice']; ?>"><br><br>
	Category:<br>
	<input type="text" name="category" placeholder="" required="required" value = "<?php echo $r['Category']; ?>"></div><br><br>
