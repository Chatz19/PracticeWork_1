...
?>
	...
	<input type="hidden" name="id" placeholder="" required="required" value = "<?php echo $r['Order_ID']; ?>"><br><br>
	Shipped Date:<br>
	<input type="text" name="date" placeholder="YYYY-MM-DD" required="required" ><br><br>
	Status:</font><br>
	<input type="text" name="status" placeholder="" required="required" ></div><br><br>
