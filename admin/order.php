...
.input{width:800px; height:50px; border-top-style:outset; border-left-style:outset; border-width: 1px 0px 1px 0px; border-color:#efefef;}
...
<img src="image/logo.jpg" height="150" width="100" align = "center"/></td><td><font class = "front">###########################</font></td><td><form action ="search.php" method = "post"><input class = "inpute" name = "names" type ="search" placeholder="search products and categories">
...
<ul>
<div class="img">
<table><th colspan="4" class="t" width="1230" height="50">All Order Placed</th><tr><td>
<li>
...
$sql = "SELECT * FROM orders WHERE Employee_ID='$ide'";
$result = mysqli_query($connection, $sql);
while($r = mysqli_fetch_assoc($result)){
	$idm = $r['Menu_ID'];


	$sqli = "SELECT * FROM menu";
...
<li><table class="f"><tr><td><img src="uploads/<?php echo $y['Image']; ?>" height="350" width="300"></a>
</td></tr>
<tr><td><table width="265"><tr></td><td><?php echo $y['Menu_Name']." - ".$y['Category'] ."<br><br><b>Order Date: ".$r['Order_Date']."<br><br><b><del>N</del> ".$r['UnitPrice'];?></b></td></tr>
<tr align = "center"><td><form action = "editorderphp.php?id=<?php echo $r['Order_ID']; ?>" method = "get"><input type="hidden" name="id" placeholder="" required="required" value = "<?php echo $r['Order_ID']; ?>">
	<input type = "submit" value ="EDIT ORDER" class = "submit">
</form></td></tr>
