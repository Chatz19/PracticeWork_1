...
<form action = "registerphp.php" method = "post" >
	...
	Job Title:<br>
	<input type="text" name="jobtitle" placeholder="" required="required"><br><br>
	Email:<br>
	<input type="email" name="email" placeholder="" required="required"></div><br>
	<div class = "class">
	...
	Image:</font><br>
	<input type="file" name="image" placeholder="Upload the Image of the Product" required="required"><br><br>
