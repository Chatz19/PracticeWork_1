...
if(isset($_POST) & !empty($_POST)){
	...
	$sql = "INSERT INTO Employee ( First_Name, Last_Name, Email, Address, Phone_Number, Password, UserName, image, Job_Title) 
	VALUES ('$firstname', '$lastname', '$email', '$address', '$mobile',  '$password', '$username', '$image', '$jobtitle') ";
