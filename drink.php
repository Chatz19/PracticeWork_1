...
<title>DRINKS</title>
<style type="text/css">
body{background: white; margin:0px; margin-top: 0px;}
...
text-transform:uppercase;}
.e{background:blue;
color:white; margin-top: 36px; height:15hv; }
...
<li align="center"><a href="home.php"><b>HOME</b></font></a></li>  
<li><a href="snacks.php"></b><b>SNACKS</b></a></li>  
<li><a href="food.php"></b><b>FOOD</b></a></li> 
...
<?php	
require_once 'config/connect.php';
$sql = "SELECT * FROM menu WHERE Category = 'Drink' LIMIT 4";
...
<?php	
require_once 'config/connect.php';
$sql = "SELECT * FROM menu WHERE Category = 'Drink' LIMIT 4,4";
$result = mysqli_query($connection, $sql); 
while ($r = mysqli_fetch_assoc($result)) {
?><td>
<li><table class="f"><tr><td><a href="viewproduct.php?name=<?php echo $r['Menu_ID']; ?>"><img src="admin/uploads/<?php echo $r['Image']; ?>" height="350" width="300"></a>
...
<?php	
require_once 'config/connect.php';
$sql = "SELECT * FROM menu WHERE Category = 'Drink' LIMIT 8,4";
$result = mysqli_query($connection, $sql); 
while ($r = mysqli_fetch_assoc($result)) {
?><td>
<li><table class="f"><tr><td><a href="viewproduct.php?name=<?php echo $r['Menu_ID']; ?>"><img src="admin/uploads/<?php echo $r['Image']; ?>" height="350" width="300"></a>
...
<?php	
require_once 'config/connect.php';
$sql = "SELECT * FROM menu WHERE Category = 'Drink' LIMIT 12,4";
$result = mysqli_query($connection, $sql); 
while ($r = mysqli_fetch_assoc($result)) {
?><td>
<li><table class="f"><tr><td><a href="viewproduct.php?name=<?php echo $r['Menu_ID']; ?>"><img src="admin/uploads/<?php echo $r['Image']; ?>" height="350" width="300"></a>
