...
if(isset($_POST) & !empty($_POST)){
	...
	$sql = "UPDATE customer SET First_Name='$fname', Last_Name='$lname', email='$email', image= '$image', Username='$username', 
	Password='$password', Mobile='$number', Address='$address' WHERE Customer_ID = $id";
	...
	if($result){
		$invalid = '<script>alert("Account Updated");</script>';
		echo $invalid;
			...
			echo $fmsg;
			header('location: editacc.php?id=3');
		}
	}
