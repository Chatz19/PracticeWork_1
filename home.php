...
<tr><td><table width="265"><tr></td><td><b><?php echo $r['Menu_Name']." - ".$r['Description'] ."<br> Quantity in stock: ".$r['QuantityInStock']."<br>&#8358 ".$r['BuyPrice'];?></b></td></tr>
