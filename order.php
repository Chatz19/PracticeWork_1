...
input.submit {width:150px; height:30px; background: orange; color:black;  border:2px solid transparent; border-radius:5px; }
...
$sql = "SELECT * FROM orders WHERE Customer_ID = '$ide'";
...
<tr><td><table width="265"><tr></td><td><b><?php echo $y['Menu_Name']." - ".$y['Category'] ."<br><br><b>Order date: ".$r['Order_Date']."<br><br><b>Status: ".$r['Status']."<br><br><b><del>N</del> ".$r['UnitPrice'];?></b></b></td></tr>
<tr align ="center"><td><form action = "delorder.php?id=<?php echo $r['Order_ID']; ?>" method = "post">
<input type="hidden" name="id" placeholder="" required="required" value = "<?php echo $r['Order_ID']; ?>">
	<input type = "submit" value ="DELETE ORDER" class = "submit">
</form></td></tr>
