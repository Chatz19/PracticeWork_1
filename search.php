...
<lialign="center"><a href="home.php"><b>HOME</b></a></li>
...
require_once 'config/connect.php';
$name = $_POST['name'];
$sql = "SELECT * FROM menu WHERE Menu_Name = '$name' OR Category = '$name'LIMIT 4";
...
require_once 'config/connect.php';
$name = $_POST['name'];
$sql = "SELECT * FROM menu WHERE Menu_Name = '$name' OR Category = '$name'LIMIT 4,4";
$result = mysqli_query($connection, $sql); 
while ($r = mysqli_fetch_assoc($result)) {
?><td>
<li><table class="f"><tr><td><a href="viewproduct.php?name=<?php echo $r['Menu_ID']; ?>"><img src="admin/uploads/<?php echo $r['Image']; ?>" height="350" width="300"></a>
...
require_once 'config/connect.php';
$name = $_POST['name'];
$sql = "SELECT * FROM menu WHERE Menu_Name = '$name' OR Category = '$name'LIMIT 8,4";
$result = mysqli_query($connection, $sql); 
while ($r = mysqli_fetch_assoc($result)) {
?><td>
<li><table class="f"><tr><td><a href="viewproduct.php?name=<?php echo $r['Menu_ID']; ?>"><img src="admin/uploads/<?php echo $r['Image']; ?>" height="350" width="300"></a>
...
require_once 'config/connect.php';
$name = $_POST['name'];
$sql = "SELECT * FROM menu WHERE Menu_Name = '$name' OR Category = '$name'LIMIT 12,4";
$result = mysqli_query($connection, $sql); 
while ($r = mysqli_fetch_assoc($result)) {
?><td>
<li><table class="f"><tr><td><a href="viewproduct.php?name=<?php echo $r['Menu_ID']; ?>"><img src="admin/uploads/<?php echo $r['Image']; ?>" height="350" width="300"></a>
