...
<?php	
require_once 'config/connect.php';
$sql = "SELECT * FROM menu WHERE Category = 'Snack'LIMIT 4";
...
<?php	
require_once 'config/connect.php';
$sql = "SELECT * FROM menu WHERE Category = 'Snack'LIMIT 4,4";
$result = mysqli_query($connection, $sql); 
while ($r = mysqli_fetch_assoc($result)) {
?><td>
<li><table class="f"><tr><td><a href="viewproduct.php?name=<?php echo $r['Menu_ID']; ?>"><img src="admin/uploads/<?php echo $r['Image']; ?>" height="350" width="300"></a>
...
<?php	
require_once 'config/connect.php';
$sql = "SELECT * FROM menu WHERE Category = 'Snack'LIMIT 8,4";
$result = mysqli_query($connection, $sql); 
while ($r = mysqli_fetch_assoc($result)) {
?><td>
<li><table class="f"><tr><td><a href="viewproduct.php?name=<?php echo $r['Menu_ID']; ?>"><img src="admin/uploads/<?php echo $r['Image']; ?>" height="350" width="300"></a>
...
<?php	
require_once 'config/connect.php';
$sql = "SELECT * FROM menu WHERE Category = 'Snack'LIMIT 12,4";
$result = mysqli_query($connection, $sql); 
while ($r = mysqli_fetch_assoc($result)) {
?><td>
<li><table class="f"><tr><td><a href="viewproduct.php?name=<?php echo $r['Menu_ID']; ?>"><img src="admin/uploads/<?php echo $r['Image']; ?>" height="350" width="300"></a>
